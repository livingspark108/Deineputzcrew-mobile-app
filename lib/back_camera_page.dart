...
// Shared cache with front_camera_page — only fetched once per app session
List<CameraDescription>? _cachedCameras;

class _BackCameraPageState extends State<BackCameraPage> {
  ...
  Future<void> _initCamera() async {
    try {
      ...
      if (backCamera == null) {
        if (mounted) setState(() => _errorMessage = AppLocalizations.of(context).noBackCameraFound);
        _signalReady();
        return;
      }
